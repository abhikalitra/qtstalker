...
VLineDialog::VLineDialog (QWidget *p, Data *set) : Dialog (p)
{
  _settings = set;
  _keySize = "vline_dialog_window_size";
  _keyPos = "vline_dialog_window_position";

  QStringList l;
  l << "QtStalker" + g_session + ":" << tr("Editing VLine Object");

...
CommandPlotDash::CommandPlotDash (QObject *p) : Command (p)
{
  _type = "PLOT_DASH";
}

int CommandPlotDash::runScript (void *d)
{
  ...
  Curve *line = new CurveLine(Qt::DashLine);
...
SettingGroup * CommandPlotDash::settings ()
{

...
CommandPlotDot::CommandPlotDot (QObject *p) : Command (p)
{
  _type = "PLOT_DOT";
}

int CommandPlotDot::runScript (void *d)
{
  ...
  Curve *line = new CurveLine(Qt::DotLine);
...
SettingGroup * CommandPlotDot::settings ()
{

...
int CommandRSI::runScript (Message *sg, Script *script)
{
  VerifyDataInput vdi;
  ...
  {
    qDebug() << "CommandRSI::runScript: invalid OUTPUT" << s;
  ...
  if (! in)
  {
    qDebug() << "CommandRSI::runScript: invalid INPUT" << s;
    emit signalResume((void *) this);
    return _ERROR;
  }
  ...
  {
    qDebug() << "CommandRSI::runScript: invalid PERIOD, using default" << s;
    period = 14;
  }

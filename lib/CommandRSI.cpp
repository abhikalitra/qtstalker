...
QString CommandRSI::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandRSI::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  Entity parms;
  parms.set(QString("FUNCTION"), Data(TypeTALibFunction::_RSI));
  ...
  {
    qDebug() << "CommandRSI::run: TALibFunction error";
    return _returnCode;
  }

...
int ADD::getCUS (QStringList &set, QHash<QString, PlotLine *> &tlines, BarData *data)
{
  // INDICATOR,PLUGIN,ADD,<NAME>,<INPUT>,<INPUT2>
  //     0       1     2    3      4        5
...
PlotLine * ADD::getADD (PlotLine *in, PlotLine *in2)
{

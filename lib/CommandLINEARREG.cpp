...
CommandLINEARREG::CommandLINEARREG ()
{
  _name = "LINEARREG";
  _method << "LR_LINEARREG" << "LR_ANGLE" << "LR_INTERCEPT" "LR_SLOPE" << "LR_TSF";
...
QString CommandLINEARREG::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandLINEARREG::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  {
    qDebug() << "CommandLINEARREG::run: TALibFunction error";
    return _returnCode;
  }

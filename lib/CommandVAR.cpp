...
QString CommandVAR::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandVAR::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  Entity parms;
  parms.set(QString("FUNCTION"), Data(TypeTALibFunction::_VAR));
  ...
  {
    qDebug() << "CommandVAR::run: TALibFunction error";
    return _returnCode;
  }

...
void CommandVAR::runScript (CommandParse sg, Script *script)
{
  if (Command::parse(sg, script))
  {
    Command::error("CommandVAR::runScript: parse error");
    return;
  }
  ...
  if (! in)
  {
    Command::error("CommandVAR::runScript: invalid Input");
    return;
  }

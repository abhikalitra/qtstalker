...
QString CommandCMO::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandCMO::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  Entity parms;
  parms.set(QString("FUNCTION"), Data(TypeTALibFunction::_CMO));
  ...
  {
    qDebug() << "CommandCMO::run: TALibFunction error";
    return _returnCode;
  }

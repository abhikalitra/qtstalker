...
void Buy::create ()
{
  emit signalMessage(QString(QObject::tr("Select point to place Buy arrow...")));
}

int Buy::create2 (QDateTime &x, double y)
{
  _saveFlag = TRUE;
  _date = x;
  _price = y;
...
void Buy::moving (QDateTime &x, double y, int)
{
  _saveFlag = TRUE;
  _date = x;
  _price = y;
...
int Buy::getHighLow (double &h, double &l)
{
  h = _price;
  l = _price;
  return 0;
...
int Buy::inDateRange (QDateTime &startDate, QDateTime &endDate, DateBar &)
{
  int rc = FALSE;

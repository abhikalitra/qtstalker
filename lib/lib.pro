...
HEADERS += CommandDataBarLength.h
HEADERS += CommandDataBool.h
HEADERS += CommandDataColor.h
HEADERS += CommandDataDateRange.h
HEADERS += CommandDataDateTime.h
HEADERS += CommandDataDouble.h
HEADERS += CommandDataFile.h
HEADERS += CommandDataFont.h
HEADERS += CommandDataGet.h
HEADERS += CommandDataInteger.h
HEADERS += CommandDataList.h
HEADERS += CommandDataMA.h
HEADERS += CommandDataOp.h
HEADERS += CommandDataSet.h
HEADERS += CommandDataString.h
HEADERS += CommandDataSymbol.h
HEADERS += CommandDialog.h
HEADERS += CommandDialogRun.h
HEADERS += CommandDialogSet.h
...
SOURCES += CommandDataBarLength.cpp
SOURCES += CommandDataBool.cpp
SOURCES += CommandDataColor.cpp
SOURCES += CommandDataDateRange.cpp
SOURCES += CommandDataDateTime.cpp
SOURCES += CommandDataDouble.cpp
SOURCES += CommandDataFile.cpp
SOURCES += CommandDataFont.cpp
SOURCES += CommandDataGet.cpp
SOURCES += CommandDataInteger.cpp
SOURCES += CommandDataList.cpp
SOURCES += CommandDataMA.cpp
SOURCES += CommandDataOp.cpp
SOURCES += CommandDataSet.cpp
SOURCES += CommandDataString.cpp
SOURCES += CommandDataSymbol.cpp
SOURCES += CommandDialog.cpp
SOURCES += CommandDialogRun.cpp
SOURCES += CommandDialogSet.cpp

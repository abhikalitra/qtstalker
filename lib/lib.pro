...
HEADERS += CommandDataGet.h
HEADERS += CommandDataSet.h
...
HEADERS += Dialog.h
HEADERS += Doc.h
HEADERS += DataBarLength.h
HEADERS += DataBool.h
HEADERS += DataColor.h
HEADERS += DataDateRange.h
HEADERS += DataDateTime.h
HEADERS += DataDouble.h
HEADERS += DataFile.h
HEADERS += DataFont.h
HEADERS += DataInteger.h
HEADERS += DataList.h
HEADERS += DataMA.h
HEADERS += DataOp.h
HEADERS += DataString.h
HEADERS += DataSymbol.h
...
SOURCES += CommandDataGet.cpp
SOURCES += CommandDataSet.cpp
...
SOURCES += Dialog.cpp
SOURCES += Doc.cpp
SOURCES += DataBarLength.cpp
SOURCES += DataBool.cpp
SOURCES += DataColor.cpp
SOURCES += DataDateRange.cpp
SOURCES += DataDateTime.cpp
SOURCES += DataDouble.cpp
SOURCES += DataFile.cpp
SOURCES += DataFont.cpp
SOURCES += DataInteger.cpp
SOURCES += DataList.cpp
SOURCES += DataMA.cpp
SOURCES += DataOp.cpp
SOURCES += DataString.cpp
SOURCES += DataSymbol.cpp

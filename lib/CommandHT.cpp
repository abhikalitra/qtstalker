...
{
  _name = "HT";
  _method << "HT_DCPERIOD" << "HT_DCPHASE" << "HT_TRENDLINE" << "HT_TRENDMODE";
  ...
  td = Data(_method, _method.at(2));
  td.setLabel(QObject::tr("Method"));
  Entity::set(QString("METHOD"), td);
}

QString CommandHT::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandHT::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  {
    qDebug() << "CommandHT::run: TALibFunction error";
    return _returnCode;
  }

/*
    ...
    Agreement version 2.4 and higher as well as under the GPL and
    the QPL.
    ...
    use the code under that agreement or you can use it under GPL or
    QPL. If you are not a holder of a Qt Commercial License Agreement,
    you can use the code under the GPL or the QPL. Regardless of the
    applicable license agreement, the Example Code may be used,

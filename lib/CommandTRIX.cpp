...
QString CommandTRIX::run (CommandParse &, void *d)
{
  ...
  {
    qDebug() << "CommandTRIX::run: invalid INPUT" << td.toString();
    return _returnCode;
  }
  ...
  Entity parms;
  parms.set(QString("FUNCTION"), Data(TypeTALibFunction::_TRIX));
  ...
  {
    qDebug() << "CommandTRIX::run: TALibFunction error";
    return _returnCode;
  }

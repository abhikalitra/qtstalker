...
int MULT::getCUS (QStringList &set, QHash<QString, PlotLine *> &tlines, BarData *data)
{
  // INDICATOR,PLUGIN,MULT,<NAME>,<INPUT>,<INPUT2>
  //     0       1     2    3      4        5
...
PlotLine * MULT::getMULT (PlotLine *in, PlotLine *in2)
{

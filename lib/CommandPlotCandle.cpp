...
CommandPlotCandle::CommandPlotCandle (QObject *p) : Command (p)
{
  _type = "PLOT_CANDLE";
}

int CommandPlotCandle::runScript (void *d)
{
...
SettingGroup * CommandPlotCandle::settings ()
{
  SettingGroup *sg = new SettingGroup;
  sg->setCommand(_type);

  SettingString *ss = new SettingString(Setting::_NONE, Setting::_CURVE, QString("candles"));
  ss->setKey("NAME");
  sg->set(ss);
  ...
  ss = new SettingString(Setting::_CHART, Setting::_NONE, QString());
  ss->setKey("CHART");
  sg->set(ss);

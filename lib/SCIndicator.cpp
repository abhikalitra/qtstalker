...
int SCIndicator::calculate (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  switch ((Method) methodList.indexOf(l[1]))
  {
    ...
    case GET_INDEX:
      ...
      break;
    case GET_INDEX_DATE:
      rc = getIndexDate(l, ba);
      break;
    case GET_RANGE:
      rc = getRange(l, ba, ind);
      break;
    case PLUGIN:
      rc = getPlugin(l, ba, ind);
      break;
    case SET_INDEX:
...
int SCIndicator::getNew (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  switch (method)
  {
    case 0:
    {
      ...
      if (out)
      {
        qDebug() << "SCIndicator::getNew: name already exists" << l.at(3);
        return 1;
      }
    ...
    default:
      out = g_barData.getInput(g_barData.getInputType(l[2]));
      if (! out)
      {
...
int SCIndicator::getIndex (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::getIndex: invalid input" << l.at(2);
    return 1;
  }
...
int SCIndicator::getIndexDate (QStringList &l, QByteArray &ba)
{
  ...
  Bar bar = g_barData.getBar(index);
  if (! bar.count())
  {
    qDebug() << "SCIndicator::getIndexDate: invalid index value" << l[2];
    return 1;
...
int SCIndicator::setIndex (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::setIndex: name not found" << l.at(2);
    return 1;
  }
...
int SCIndicator::getRange (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::getRange: invalid input" << l.at(2);
    return 1;
  }
...
int SCIndicator::setColor (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::setColor: name not found" << l.at(2);
    return 1;
  }
...
int SCIndicator::getPlugin (QStringList &l, QByteArray &ba, Indicator &ind)
{
...
int SCIndicator::setDelete (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  {
    qDebug() << "SCIndicator::getDelete: name not found" << l.at(2);
    return 1;
  }
...
int SCIndicator::setColorAll (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::setColorAll: name not found" << l.at(2);
    return 1;
  }
...
int SCIndicator::setPlotStyle (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::setPlotStyle: name not found" << l.at(2);
    return 1;
  }
...
int SCIndicator::setPlot (QStringList &l, QByteArray &ba, Indicator &ind)
{
  ...
  if (! line)
  {
    qDebug() << "SCIndicator::setPlot: name not found" << l.at(2);
    return 1;
  }
  ...
  if (! ok)
  {
    qDebug() << "SCIndicator::setPlot: invalid z value" << l.at(3);
    return 1;
  }

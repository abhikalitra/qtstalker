...
int SUB::getCUS (QStringList &set, QHash<QString, PlotLine *> &tlines, BarData *data)
{
  // INDICATOR,PLUGIN,SUB,<NAME>,<INPUT>,<INPUT2>
  //     0       1     2    3      4        5
...
PlotLine * SUB::getSUB (PlotLine *in, PlotLine *in2)
{

...
void ChartPage::addToGroup ()
{
  ...
  prepareScript(script, "ChartPanelAddGroup", "perl", "ChartPanelAddGroup.pl");
}
...
{
  Script *script = new Script;
  prepareScript(script, "ChartPanelSymbolSearch", "perl", "ChartPanelSymbolSearch.pl");
}
...
void ChartPage::prepareScript (Script *script, QString name, QString command, QString file)
{
  script->setName(name);

...
int AROONOSC::getIndicator (Indicator &ind, BarData *data)
{
...
int AROONOSC::getCUS (QStringList &set, QHash<QString, PlotLine *> &tlines, BarData *data)
{
...
PlotLine * AROONOSC::getAROONOSC (BarData *data, int period)
{
  int size = data->count();
  TA_Real high[size];
  TA_Real low[size];

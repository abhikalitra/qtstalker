...
void GroupPage::newGroup ()
{
  ...
  prepareScript(script, "GroupPanelNewGroup", "perl", "GroupPanelNewGroup.pl");
}

void GroupPage::editGroup ()
{
  Script *script = new Script;
  prepareScript(script, "GroupPanelEditGroup", "perl", "GroupPanelEditGroup.pl");
}

void GroupPage::deleteGroup()
{
  Script *script = new Script;
  prepareScript(script, "GroupPanelDeleteGroup", "perl", "GroupPanelDeleteGroup.pl");
}

...
CommandChartPanel::CommandChartPanel ()
{
  _name = "CHART_PANEL";
  _method << "REFRESH" << "SELECT" << "RELOAD";
...
QString CommandChartPanel::run (CommandParse &, void *d)
{
  Data method;
  ...
  switch (_method.indexOf(method.toString()))
  {
    ...
    case 2: // RELOAD
      ...
      break;
    default:
      qDebug() << "CommandChartPanel::run: invalid method" << method.toString();
      return _returnCode;
      break;
  }
...
int CommandChartPanel::select (void *d)
{
...
int CommandChartPanel::refresh (void *d)
{
  Script *script = (Script *) d;
...
int CommandChartPanel::reload (void *d)
{
  Script *script = (Script *) d;
  
  Entity e;
  e.set(QString("MESSAGE"), Data(TypeThreadMessage::_CHART_PANEL_RELOAD));

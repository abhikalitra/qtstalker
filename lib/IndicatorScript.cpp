...
IndicatorScript::IndicatorScript (BarData *bd)
{
  ...
  data = bd;
  data->getInputFields(inputFieldList);
...
void IndicatorScript::getIndicatorList (QStringList &l)
{
  l = indicatorList;
}

void IndicatorScript::getIndicator (QStringList &l, QByteArray &ba)
{
  ...
  if (l.count() != 2)
  {
    qDebug() << "IndicatorScript::getIndicator: parm error " << l;
    ba.append("ERROR\n");
    return;
  }
  ...
  if (! in)
  {
    ...
    if (! in)
    {
      qDebug() << "IndicatorScript::getIndicator: cannot create input" << l[1];
      ba.append("ERROR\n");
      return;
    }
...
void IndicatorScript::setIndicator (QStringList &l, QByteArray &ba)
{
  ...
  if (l.count() < 3)
  {
    qDebug() << "IndicatorScript::setIndicator: parm error " << l;
    ba.append("1\n");
    return;
  }
  ...
  if (line)
  {
    ...
    qDebug() << "IndicatorScript::setIndicator: duplicate variable name" << l[1];
    ba.append("1\n");
    return;
  }
...
int IndicatorScript::plot (QStringList &l)
{
  // format 'PLOT,NAME,LABEL,COLOR,LINE_TYPE'
  if (l.count() != 5)
  {
    qDebug() << "IndicatorScript::plot: parm error" << l;
    return 1;
  }
  ...
  if (! line)
  {
    qDebug() << "IndicatorScript::plot: bad line name" << l[1];
    return 1;
  }
...
void IndicatorScript::getLines (QList<PlotLine *> &lines)
{
  int loop;
...
int IndicatorScript::parseIndicator (QStringList &l)
{
  int rc = FALSE;
  ...
  set.setIndicator(l[1]);
  
  DataBase db;
  db.getIndicatorSettings(set);
  
  if (l.count() - 2 != set.count())
  {
    qDebug() << "IndicatorScript::parseIndicator: item count" << l.count() - 2 << set.count();
    return 1;
  }
    ...
    switch ((IndicatorSettings::Type) type)
    {
      ...
      case IndicatorSettings::TypeInput2:
        if (! tlines.contains(val))
        {
          ...
          {
            qDebug() << "IndicatorScript::parseIndicator: cannot create input" << val;
            return 1;
          }
        }
        break;
      ...
      case IndicatorSettings::TypeOutput3:
        if (val.isEmpty())
        {
          qDebug() << "IndicatorScript::parseIndicator: output" << name << "is empty";
          return 1;
        }
        break;
      case IndicatorSettings::TypeInt:
      {
        ...
        if (! ok)
        {
          qDebug() << "IndicatorScript::parseIndicator:" << val << "is not a integer";
          return 1;
        }
        break;
      }
      case IndicatorSettings::TypeDouble:
      {
        ...
        if (! ok)
        {
          qDebug() << "IndicatorScript::parseIndicator:" << val << "is not valid";
          return 1;
        }
        break;
      }
      case IndicatorSettings::TypeColor:
      {
        ...
        if (! c.isValid())
        {
          qDebug() << "IndicatorScript::parseIndicator:" << val << "is not a color";
          return 1;
        }
        break;
      }
      ...
      case IndicatorSettings::TypeSymbol:
        if (val.isEmpty())
        {
          qDebug() << "IndicatorScript::parseIndicator: symbol" << name << "is empty";
          return 1;
        }
        break;
      default:
...
//**********************************************************************************
int IndicatorScript::getInput (IndicatorSettings &set, int i)
{
  QString s;
  int flag = FALSE;
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "IndicatorScript::getInput: TA-Lib error" << rc;
    return 1;
  }
...
//***************************************************
int IndicatorScript::getFieldInput (IndicatorSettings &set, int i)
{
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "IndicatorScript::getFieldInput: TA-Lib error" << rc;
    return 1;
  }
...
//***************************************************
int IndicatorScript::getInput2 (IndicatorSettings &set, int i)
{
  QString s;
  int flag = FALSE;
  int flag2 = FALSE;
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "IndicatorScript::getInput2: TA-Lib error" << rc;
    return 1;
  }
...
//********** CDL  ***********************************
//***************************************************
int IndicatorScript::getCDL (IndicatorSettings &set, int i)
{
  // format 'CDL,NAME'
  ...
  if (rc != TA_SUCCESS)
  {
    qDebug() << "IndicatorScript::getCDL: TA-Lib error" << rc;
    return 1;
  }
...
//********** BARS ***********************************
//***************************************************
int IndicatorScript::getBARS (IndicatorSettings &set)
{
...
//********** CANDLES ********************************
//***************************************************
int IndicatorScript::getCANDLES (IndicatorSettings &set)
{
...
//********** REF ************************************
//***************************************************
int IndicatorScript::getREF (IndicatorSettings &set)
{
...
//********** COMPARE ********************************
//***************************************************
int IndicatorScript::getCOMPARE (IndicatorSettings &set)
{
...
//********** COMPARE2 ********************************
//***************************************************
int IndicatorScript::getCOMPARE2 (IndicatorSettings &set)
{
...
//********** COLOR ********************************
//***************************************************
int IndicatorScript::getCOLOR (IndicatorSettings &set)
{
...
//********** NORMAL *********************************
//***************************************************
int IndicatorScript::getNORMAL (IndicatorSettings &set)
{
...
//********** SYMBOL *********************************
//***************************************************
int IndicatorScript::getSYMBOL (IndicatorSettings &set)
{

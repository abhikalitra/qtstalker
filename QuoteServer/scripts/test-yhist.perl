# this script downloads all the yahoo history the entrire S&P500 
...
my @list = split(',', $symbols);

# we loop through the symbol list
foreach (@list)
{
  # open a socket to the quote server using the server defaults

...
SUBDIRS += plugins/script/GROUP_DELETE_DIALOG
SUBDIRS += plugins/script/GROUP_EDIT_DIALOG
SUBDIRS += plugins/script/GROUP_NEW_DIALOG
SUBDIRS += plugins/script/GROUP_SELECT_DIALOG
...
SUBDIRS += plugins/script/INDICATOR_DELETE_DIALOG
...
SUBDIRS += plugins/script/SCRIPT_NEW_DIALOG
#SUBDIRS += plugins/script/SCRIPT_RUN
#SUBDIRS += plugins/script/SCRIPT_RUN_FILE_DIALOG
SUBDIRS += plugins/script/SCRIPT_SELECT_DIALOG

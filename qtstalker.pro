...
SUBDIRS += plugins/script/CHART_OBJECT_NEW
...
SUBDIRS += plugins/script/INDICATOR_PLOT_DATE_GET
SUBDIRS += plugins/script/INDICATOR_PLOT_DELETE
SUBDIRS += plugins/script/INDICATOR_PLOT_INDEX_DELETE
...
SUBDIRS += plugins/script/INTEGER_DIALOG

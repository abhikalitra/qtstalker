...
SUBDIRS += plugins/script/INDICATOR_PLOT_INDEX_GET
SUBDIRS += plugins/script/INDICATOR_PLOT_INDEX_OFFSET
SUBDIRS += plugins/script/INDICATOR_PLOT_INDEX_RANGE
SUBDIRS += plugins/script/INDICATOR_PLOT_INDEX_SET

...
BuyDialog::BuyDialog (QWidget *p, Data *set) : Dialog (p)
{
  _settings = set;
  _keySize = "buy_dialog_window_size";
  _keyPos = "buy_dialog_window_position";

  QStringList l;
  l << "QtStalker" + g_session + ":" << tr("Editing Buy Object");

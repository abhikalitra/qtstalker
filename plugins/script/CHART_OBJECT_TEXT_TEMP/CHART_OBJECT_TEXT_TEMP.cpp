...
#include "CHART_OBJECT_TEXT_TEMP.h"

#include <QtDebug>

CHART_OBJECT_TEXT_TEMP::CHART_OBJECT_TEXT_TEMP ()
{
  _plugin = "CHART_OBJECT_TEXT_TEMP";
}

int CHART_OBJECT_TEXT_TEMP::command (Command *command)
{
  // PARMS:
  // DATE
  // PRICE
...
{
  CHART_OBJECT_TEXT_TEMP *o = new CHART_OBJECT_TEXT_TEMP;

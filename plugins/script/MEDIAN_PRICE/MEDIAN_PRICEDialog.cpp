...
MEDIAN_PRICEDialog::MEDIAN_PRICEDialog (QWidget *p, Setting *set) : QWidget (p)
{
  _settings = set;
  createGeneralPage();
}

void MEDIAN_PRICEDialog::createGeneralPage ()
{

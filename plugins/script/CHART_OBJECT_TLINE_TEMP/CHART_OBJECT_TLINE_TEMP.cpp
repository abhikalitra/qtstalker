...
#include "CHART_OBJECT_TLINE_TEMP.h"

#include <QtDebug>

CHART_OBJECT_TLINE_TEMP::CHART_OBJECT_TLINE_TEMP ()
{
  _plugin = "CHART_OBJECT_TLINE_TEMP";
}

int CHART_OBJECT_TLINE_TEMP::command (Command *command)
{
  // PARMS:
  // DATE
  // DATE2
...
{
  CHART_OBJECT_TLINE_TEMP *o = new CHART_OBJECT_TLINE_TEMP;

...
STDDEVDialog::STDDEVDialog (QWidget *p, Setting *set) : QWidget (p)
{
  _settings = set;
  createGeneralPage();
}

void STDDEVDialog::createGeneralPage ()
{
...
void STDDEVDialog::save ()
{
  ...
  _settings->setData("DEVIATION", _dev->text());
}

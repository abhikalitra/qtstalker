...
#ifndef PLUGIN_LINE_DRAW_HPP
#define PLUGIN_LINE_DRAW_HPP
...
class LineDraw : public QwtPlotCurve
{
  public:
    explicit LineDraw (const QString &title = QString::null);
    explicit LineDraw (const QwtText &title);
    virtual ~LineDraw ();

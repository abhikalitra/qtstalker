...
#include "CHART_OBJECT_SELL_TEMP.h"

#include <QtDebug>

CHART_OBJECT_SELL_TEMP::CHART_OBJECT_SELL_TEMP ()
{
  _plugin = "CHART_OBJECT_SELL_TEMP";
}

int CHART_OBJECT_SELL_TEMP::command (Command *command)
{
  // PARMS:
  // DATE
  // PRICE
...
{
  CHART_OBJECT_SELL_TEMP *o = new CHART_OBJECT_SELL_TEMP;

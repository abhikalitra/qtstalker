...
CMOWidget::CMOWidget (QWidget *p) : PluginWidget (p)
{
  createGeneralPage();
}

void CMOWidget::createGeneralPage ()
{
...
void CMOWidget::setCommand (QString d)
{
  Command command(d);
  if (command.parm("PLUGIN") != "CMO")
    return;
...
void CMOWidget::commands (QStringList &l, int tab)
{
  QStringList cl;
  cl << "PLUGIN=CMO";

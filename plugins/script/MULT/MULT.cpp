...
int MULT::command (Command *command)
{
  // PARMS:
  // NAME
  // INPUT
...
QWidget * MULT::dialog (QWidget *p, Setting *set)
{
  return new MULTDialog(p, set);
}

void MULT::defaults (Setting *set)
{

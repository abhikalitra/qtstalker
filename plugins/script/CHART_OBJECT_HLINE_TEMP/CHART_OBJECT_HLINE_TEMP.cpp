...
#include "CHART_OBJECT_HLINE_TEMP.h"

#include <QtDebug>

CHART_OBJECT_HLINE_TEMP::CHART_OBJECT_HLINE_TEMP ()
{
  _plugin = "CHART_OBJECT_HLINE_TEMP";
}

int CHART_OBJECT_HLINE_TEMP::command (Command *command)
{
  // PARMS:
  // PRICE
  // COLOR
...
{
  CHART_OBJECT_HLINE_TEMP *o = new CHART_OBJECT_HLINE_TEMP;

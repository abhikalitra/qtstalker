...
#include "CHART_OBJECT_SELL_DIALOG.h"
...
int CHART_OBJECT_SELL_DIALOG::command (Command *command)
{
  ...
  ChartObjectSellDialog *dialog = new ChartObjectSellDialog(_parent, command);
...
{
  CHART_OBJECT_SELL_DIALOG *o = new CHART_OBJECT_SELL_DIALOG;

...
int ADD::calculate (BarData *bd, Indicator *i, Setting *settings)
{
  int delFlag = FALSE;
...
QWidget * ADD::dialog (QWidget *p, Setting *set)
{
  return new ADDDialog(p, set);
}

void ADD::defaults (Setting *set)
{

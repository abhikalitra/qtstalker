...
#include "CHART_OBJECT_BUY_TEMP.h"

#include <QtDebug>

CHART_OBJECT_BUY_TEMP::CHART_OBJECT_BUY_TEMP ()
{
  _plugin = "CHART_OBJECT_BUY_TEMP";
}

int CHART_OBJECT_BUY_TEMP::command (Command *command)
{
  // PARMS:
  // DATE
  // PRICE
...
{
  CHART_OBJECT_BUY_TEMP *o = new CHART_OBJECT_BUY_TEMP;

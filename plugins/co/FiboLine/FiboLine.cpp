...
FiboLine::FiboLine ()
{
  ...
  menu->insertItem(tr("&Edit FiboLine"), this, SLOT(prefDialog()), CTRL+Key_E);
  menu->insertItem(tr("&Move FiboLine"), this, SLOT(moveObject()), CTRL+Key_M);
  menu->insertItem(tr("&Delete FiboLine"), this, SLOT(removeObject()), CTRL+Key_D);

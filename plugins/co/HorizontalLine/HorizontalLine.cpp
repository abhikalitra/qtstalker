...
HorizontalLine::HorizontalLine ()
{
  ...
  menu->insertItem(QPixmap(edit), tr("&Edit HorizontalLine"), this, SLOT(prefDialog()), CTRL+Key_E);
  menu->insertItem(QPixmap(renam), tr("&Move HorizontalLine"), this, SLOT(moveObject()), CTRL+Key_M);
  menu->insertItem(QPixmap(deleteitem), tr("&Delete HorizontalLine"), this, SLOT(removeObject()), CTRL+Key_D);

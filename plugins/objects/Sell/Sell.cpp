...
void Sell::draw (ChartObject *co, QPixmap &buffer, BarData *data, int startX, int pixelspace,
...
void Sell::dialog (ChartObject *co)
{
...
void Sell::setSettings (ChartObject *co, QSqlQuery &q)
{
...
void Sell::getSettings (ChartObject *co, QString &set)
{
...
void Sell::create (ChartObject *co)
{
  QString s = "Sell";
  co->setData(ChartObject::ParmPlugin, s);
  ...
  s = QObject::tr("Select point to place Sell arrow...");
  co->message(s);
}

int Sell::create2 (ChartObject *co, QDateTime &x, double y)
{
  co->setData(ChartObject::ParmSave, TRUE);
...
void Sell::moving (ChartObject *co, QDateTime &x, double y, int)
{
  co->setData(ChartObject::ParmSave, TRUE);
  co->setData(ChartObject::ParmDate, x);
  co->setData(ChartObject::ParmPrice, y);
